...
*   **Atividade 1.2: Definição do Problema, Objetivos e Justificativa** (Rubrica **H34a**)
    *   *Percentual de Conclusão*: `0%`
    *   *Evidência*: (Ex: Preenchimento das seções 1.1 e 1.2 de docs/contexto.md)
    *   *Feedback*: Aguardando a postagem do escopo inicial da aplicação.
*   **Atividade 1.4: Catálogo de Serviços Web e Planejamento de SLAs** (Rubrica **H34a**)
    *   *Percentual de Conclusão*: `0%`
    *   *Evidência*: (Ex: Preenchimento da tabela em docs/contexto.md#3.0)
    *   *Feedback*: Aguardando a formalização dos termos de serviço da aplicação.

---

### ⚙️ ETAPA 2 - Desenvolvimento de APIs e Persistência Backend
*   **Atividade 2.1: Estruturação Inicial e Instalação** (Rubrica **H36b**)
    *   *Percentual de Conclusão*: `0%`
    *   *Evidência*: (Ex: Inicialização do projeto APIs em src/backend/ e arquivo README de instalação)
    *   *Feedback*: Aguardando inicialização do repositório backend.
*   **Atividade 2.7: Configuração de Docker e Orquestração Local** (Rubrica **H35c**)
    *   *Percentual de Conclusão*: `0%`
    *   *Evidência*: (Ex: Criação e autoria de Dockerfile e docker-compose.yml de serviços)
    *   *Feedback*: Aguardando a criação dos contêineres de inicialização local de infraestrutura.

---

### 💻 ETAPA 3 - Interface Web Responsiva e Integração de APIs
*   **Atividade 3.1: Inicialização do Projeto Web** (Rubrica **H37b**)
    *   *Percentual de Conclusão*: `0%`
    *   *Evidência*: (Ex: Criação da estrutura de pastas em src/frontend/ e configurações de build)
    *   *Feedback*: Aguardando postagem das dependências e estrutura do front-end web.
*   **Atividade 3.7: Estruturação de Build Otimizado e Docker Web** (Rubrica **H35c**)
    *   *Percentual de Conclusão*: `0%`
    *   *Evidência*: (Ex: Otimização de assets e contêiner Nginx de distribuição)
    *   *Feedback*: Aguardando o empacotamento estático de produção do cliente web.

---

### 📱 ETAPA 4 - Interface Móvel e Integração de Recursos Físicos
*   **Atividade 4.1: Inicialização do Projeto Mobile** (Rubrica **H38b**)
    *   *Percentual de Conclusão*: `0%`
    *   *Evidência*: (Ex: Instanciação do boilerplate do app em src/mobile/ e arquivo README móvel)
    *   *Feedback*: Aguardando o setup do boilerplate móvel.
*   **Atividade 4.7: Empacotamento de Builds e Provisionamento Nativo** (Rubrica **H35c**)
    *   *Percentual de Conclusão*: `0%`
    *   *Evidência*: (Ex: Configuração de profiles iOS/Android, gradle e fastlane/Expo EAS)
    *   *Feedback*: Aguardando provisionamento de build nativo ou emulação do aplicativo.
