...
*   **Atividade 1.3: Análise e Especificação de Requisitos** (Rubrica **H34a**)
    *   *Percentual de Conclusão*: `0%`
    *   *Evidência*: (Ex: Preenchimento das seções de Requisitos Funcionais e Não Funcionais em docs/contexto.md)
    *   *Feedback*: Aguardando a postagem estruturada e priorização de RFs/RNFs.
*   **Atividade 1.8: Design Visual e Wireframes do Frontend Web** (Rubrica **H37a**)
    *   *Percentual de Conclusão*: `0%`
    *   *Evidência*: (Ex: Inclusão dos diagramas e fluxos de navegação na seção 6.0 de docs/contexto.md)
    *   *Feedback*: Aguardando a inclusão de rascunhos de telas/wireframes e mapa de navegação web.

---

### ⚙️ ETAPA 2 - Desenvolvimento de APIs e Persistência Backend
*   **Atividade 2.3: Construção de Endpoints de APIs / Lógica CRUD** (Rubrica **H36b**)
    *   *Percentual de Conclusão*: `0%`
    *   *Evidência*: (Ex: Codificação dos controllers, rotas e mapeamento de payloads em src/backend/)
    *   *Feedback*: Aguardando a estruturação física das funções de persistência e recursos das rotas lógicas.

---

### 💻 ETAPA 3 - Interface Web Responsiva e Integração de APIs
*   **Atividade 3.3: Construção das Telas Chaves da Aplicação Web** (Rubrica **H37b**)
    *   *Percentual de Conclusão*: `0%`
    *   *Evidência*: (Ex: Codificação de views, controllers ou componentes com estados em src/frontend/)
    *   *Feedback*: Aguardando a criação e acoplamento estutural de páginas web de interação da console.

---

### 📱 ETAPA 4 - Interface Móvel e Integração de Recursos Físicos
*   **Atividade 4.3: Desenvolvimento de Componentes e Telas de App Móvel** (Rubrica **H38b**)
    *   *Percentual de Conclusão*: `0%`
    *   *Evidência*: (Ex: Codificação de componentes visuais locais em src/mobile/)
    *   *Feedback*: Aguardando a codificação de views específicas no aplicativo móvel.
